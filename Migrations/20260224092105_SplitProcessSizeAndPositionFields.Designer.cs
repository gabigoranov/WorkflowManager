...
namespace WorkflowManager.Migrations
{
    ...
    [Migration("20260224092105_SplitProcessSizeAndPositionFields")]
    partial class SplitProcessSizeAndPositionFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkflowManager.Models.AppProcess", b =>
                {
                    b.HasBaseType("WorkflowManager.Models.Common.Process");

                    b.Property<string>("ArgumentDirectory")
                        .HasMaxLength(255)
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("Processes", t =>
                        {
                            t.Property("Directory")
                                .HasColumnName("AppProcess_Directory");
                        });
